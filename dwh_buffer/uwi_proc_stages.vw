create or replace force view dwh_buffer.uwi_proc_stages as
...
grant select on DWH_BUFFER.UWI_PROC_STAGES to AIBEK_BE;
grant select on DWH_BUFFER.UWI_PROC_STAGES to DWH_PRIM;
grant select on DWH_BUFFER.UWI_PROC_STAGES to DWH_RISK;
grant select on DWH_BUFFER.UWI_PROC_STAGES to DWH_SALES;
grant select on DWH_BUFFER.UWI_PROC_STAGES to HEAD_DENIS_PL;
grant select on DWH_BUFFER.UWI_PROC_STAGES to HEAD_EVGENIY_PI;
grant select on DWH_BUFFER.UWI_PROC_STAGES to KRISTINA_KO;
grant select on DWH_BUFFER.UWI_PROC_STAGES to PROCESS_RISK;
grant select on DWH_BUFFER.UWI_PROC_STAGES to PROCESS_SALES;
